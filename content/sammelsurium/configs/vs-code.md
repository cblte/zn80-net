...
**Note:** This guide is heavily inspired by <https://parsiya.io/configs/vscode/> and was originally made in early 2019. I have adopted it and changed it to my needs. Feel free to use as much as you like. Here you can download my [vs-code-settings.json](/sammelsurium/configs/files/vs-code-settings.json) is
